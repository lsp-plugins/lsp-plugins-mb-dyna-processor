...
#define LSP_PLUGINS_MB_DYNA_PROCESSOR_VERSION_MICRO       32
...
namespace lsp
{
    namespace meta
    {
        ...
        static const port_item_t mb_dyna_sc_bands[] =
        {
            ...
            { "Band 8",         "mb_dyna_processor.band8" },
            { NULL, NULL }
        };
        ...
        static const port_item_t mb_dyna_sc_lr_bands[] =
        {
            ...
            { "Band 8 Left",    "mb_dyna_processor.band8_left"      },
            { "Band 8 Right",   "mb_dyna_processor.band8_right"     },
            { NULL, NULL }
        };
        ...
        static const port_item_t mb_dyna_sc_ms_bands[] =
        {
            ...
            { "Band 8 Mid",     "mb_dyna_processor.band8_middle"    },
            { "Band 8 Side",    "mb_dyna_processor.band8_side"      },
            { NULL, NULL }
        };
        ...
        #define MB_DYNA_POINT(idx, sidx, on, id, label, alias, level) \
            SWITCH("pe" #idx id, "Point enable " #sidx label, "Point on " #sidx alias, on), \
            LOG_CONTROL_DFL("tl" #idx id, "Threshold " #sidx label, "Thresh " #sidx alias, U_GAIN_AMP, mb_dyna_processor::THRESHOLD, level), \
            LOG_CONTROL_DFL("gl" #idx id, "Gain " #sidx label, "Gain " #sidx alias, U_GAIN_AMP, mb_dyna_processor::THRESHOLD, level), \
            LOG_CONTROL("kn" #idx id, "Knee " #sidx label, "Knee " #sidx alias, U_GAIN_AMP, mb_dyna_processor::KNEE), \
            SWITCH("ae" #idx id, "Attack enable " #sidx label, "Att on " #sidx alias, 0.0f), \
            LOG_CONTROL_DFL("al" #idx id, "Attack level " #sidx label, "Att lvl " #sidx alias, U_GAIN_AMP, mb_dyna_processor::ATTACK_LVL, level), \
            LOG_CONTROL("at" #idx id, "Attack time " #sidx label, "Att time " #sidx alias, U_MSEC, mb_dyna_processor::ATTACK_TIME), \
            SWITCH("re" #idx id, "Release enable " #sidx label, "Rel on " #sidx alias, 0.0f), \
            LOG_CONTROL_DFL("rl" #idx id, "Release level " #sidx label, "Rel lvl " #sidx alias, U_GAIN_AMP, mb_dyna_processor::RELEASE_LVL, level), \
            LOG_CONTROL("rt" #idx id, "Release time " #sidx label, "Rel time " #sidx alias, U_MSEC, mb_dyna_processor::RELEASE_TIME)
        ...
        #define MB_BAND_COMMON(id, label, alias, x, total, fe, fs) \
            ...
            MB_DYNA_POINT(0, 1, 1.0f, id, label, alias, GAIN_AMP_M_12_DB), \
            MB_DYNA_POINT(1, 2, 0.0f, id, label, alias, GAIN_AMP_M_24_DB), \
            MB_DYNA_POINT(2, 3, 0.0f, id, label, alias, GAIN_AMP_M_36_DB), \
            MB_DYNA_POINT(3, 4, 0.0f, id, label, alias, GAIN_AMP_M_48_DB), \
